...
function RestroCard(props){
    ...
    return(
        <div className="res-card">
            <img className="res-logo" alt="images" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" + restData.info.cloudinaryImageId} />
...
const resList=[
        ...
        },
        {
          "info": {
            ...
            "availability": {
              "nextCloseTime": "2024-05-16 03:45:00",
              "opened": true
            },
            "badges": {
              "imageBadges": [
        ...
        },
        {
          ...
          "cta": {
            "link": "https://www.swiggy.com/restaurants/biryani-badshah-maan-road-hinjawadi-pune-429029",
            "type": "WEBLINK"
          }
        },
        {
...
export const Body = () => {
    return (
        <div className="body">
            ...
            {
                resList.map(restaurant => <RestroCard key={restaurant.info.id} restData={restaurant}/>)
            }
            </div>
        </div>
    );
